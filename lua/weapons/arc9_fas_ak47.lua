...
SWEP.Description = [[Iconic automatic rifle produced in the tens of millions. The most recognizable gun in the world, which served as the main service rifle for Soviet forces until it was replaced by the AK-74 in the 1970s. The AKM is a modernized version of the AK-47, with a new gas system and a new trigger mechanism. It is still in service with many countries, including Russia, China, and North Korea.

The rifle offers great firepower, but is poor at range and has poor recoil.]]

SWEP.ViewModel = "models/weapons/arc9_fas/rifles/ak47.mdl"
...
local path = "^weapons/arc9_fas/ak47/ak47_"
...
SWEP.AttachmentElements = {
    ...
    ["fas_ak47_barrel_long"] = {
        Bodygroups = {
            {2, 1}
        },
        AttPosMods = {
            [1] = {
                Pos = Vector(0, 38.7, 1.9),
            }
        }
    },
    ["fas_ak47_barrel_short"] = {
        Bodygroups = {
            {2, 2}
        },
        AttPosMods = {
            [1] = {
                Pos = Vector(0, 26.6, 1.9),
            }
        }
    },
    ["fas_ak47_mag_10"] = {
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/ak47_a.mdl",
        Category = "stickers",
    },
}