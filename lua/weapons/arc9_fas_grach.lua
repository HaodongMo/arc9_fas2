...
SWEP.Description = [[Known also as "PYa" ("Pistolet Yarygin"), the MP-443 is the main service pistol for the Russian Armed Forces.]]

SWEP.ViewModel = "models/weapons/arc9_fas/pistols/grach.mdl"
...
SWEP.RangeMax = 3200 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.PhysBulletMuzzleVelocity = 1470 * 12
...
SWEP.Attachments = {
    ...
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/grach_a.mdl",
        Category = "stickers",
    },
}