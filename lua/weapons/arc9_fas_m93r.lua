...
SWEP.Description = [[Three-round burst 9mm pistol.]]

SWEP.ViewModel = "models/weapons/arc9_fas/pistols/m9.mdl"
...
local path_pernach = "weapons/arc9_fas/ots33/ots33_"
local common = "weapons/arc9_fas/"


SWEP.ShootSound = path_pernach .. "fire1.wav"
SWEP.DistantShootSound = "^" .. path_pernach .. "distance_fire1.wav"
SWEP.ShootSoundSilenced = path_pernach .. "suppressed_fire1.wav"
