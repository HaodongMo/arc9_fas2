...
SWEP.Attachments = {
    ...
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/m60_a.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/m60_b.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/m60_c.mdl",
        Category = "stickers",
    },
}