...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = "charm",
        Bone = "weapon_main",
        Pos = Vector(0.92, 4, 0.9),
        Ang = Angle(0, -90, 0),
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/sg550_b.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/sg550_a.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/sg550_c.mdl",
        Category = "stickers",
    },
}