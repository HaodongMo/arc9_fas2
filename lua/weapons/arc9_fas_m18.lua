...
SWEP.Trivia = {
    Manufacturer = "Pyrotechnical Specialties Inc.",
    Mechanism = "Pyrotechnic Fuze",
    Origin = "United States of America",
    ["Explosive Mass"] = "326g",
    ["Explosive Type"] = "Smoke Mix"
}
...
SWEP.Description = [[Smoke grenade, in use since World War 2.

Produces a large smokescreen.]]

SWEP.ViewModel = "models/weapons/arc9_fas/explosives/smoke.mdl"
...
SWEP.ShootEnt = "fas_nade_m18_thrown" -- Set to an entity to launch it out of this weapon.
