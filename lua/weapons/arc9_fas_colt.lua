...
SWEP.Trivia = {
    ...
    Mechanism = "Closed-Bolt Blowback",
...
SWEP.Description = [[The Colt Model 639 was developed in the 1980s as a compact and lightweight alternative to the larger M16 assault rifle. It was designed for use by military and law enforcement special operations units, and was intended for close-quarter combat and covert operations. It has since been replaced by newer models in many cases, but is still in use in some areas.

Burst-fire-only submachine gun. Very ergonomic, with great recoil characteristics.]]
...
SWEP.PhysBulletMuzzleVelocity = 1390 * 12
...
SWEP.Attachments = {
    ...
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/colt_a.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/colt_b.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/colt_c.mdl",
        Category = "stickers",
    },
}