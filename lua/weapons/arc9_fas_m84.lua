...
SWEP.Trivia = {
    ...
    ["Explosive Mass"] = "4.5g",
    ["Explosive Type"] = "Magnesium/Ammonium Nitrate"
}
...
SWEP.Description = [[Standard-issue flash grenade.

Produces a bright flash and loud bang to disorient enemies.]]

SWEP.ViewModel = "models/weapons/arc9_fas/explosives/flashbang.mdl"
...
SWEP.ShootEnt = "fas_nade_m84_thrown" -- Set to an entity to launch it out of this weapon.
