...
SWEP.Description = [[Based on experience in the Vietnam War, the M16A2 comes with many improvements over the older M16A1 pattern rifle. Among other changes, it comes with a spent case deflector, thicker barrel, enhanced handguard, adjustable rear sight, and improved flash hider. Most noticeable, however, is its three-round-burst fire mode, created as a compromise solution between the Army, who wanted it to be semi-auto only, and the Air Force, who wanted it to be fully automatic.

Pace bursts well to kill very fast. Low recoil. Good fire rate.]]

SWEP.ViewModel = "models/weapons/arc9_fas/rifles/m16a2.mdl"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = ARC9FAS.Cloth_Movement, t = 62 / 30},
        },
        IKTimeLine = {
            {
                t = 0,
...
SWEP.Attachments = {
    {
        ...
        Pos = Vector(0.1, 21, 1.9),
        Ang = Angle(0, -90, 0),
    },
    {
        PrintName = "BARREL",
        Category = "fas_m16_barrel",
        Bone = "smdimport",
        Pos = Vector(0.1, 0, 1.9),
        Ang = Angle(0, -90, 0),
    },
    {
        PrintName = "OPTIC",
    ...
    },
    {
        ...
        Bone = "smdimport",
        Pos = Vector(0.1, 3, 3.6),
        Ang = Angle(0, -90, 1),
        InstalledElements = {"backup"}
    },
    {
        PrintName = "MAG",
        Category = {"fas_m16_mag", "fas_mag_556", "fas_mag_pull"},
        Bone = "Magazine",
        Pos = Vector(0, -0.5, 4.2),
        Ang = Angle(0, -90, 0),
    },
    {
        PrintName = "STOCK",
    ...
    },
    {
        ...
        Category = "charm",
        Bone = "smdimport",
        Pos = Vector(0.5, -5.5, 4.75),
        Ang = Angle(0, -90, 0),
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/m16_a.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/m16_b.mdl",
        Category = "stickers",
    },
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/m16_c.mdl",
        Category = "stickers",
    },
}